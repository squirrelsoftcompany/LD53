...
func createAsteroid(pPosition : Vector3) -> void :
	...
	asteroid.linear_velocity.x = rng.randi_range(-20,20)
	asteroid.linear_velocity.y = rng.randi_range(-20,20)
	asteroid.linear_velocity.z = rng.randi_range(-20,20)
	asteroid.angular_velocity.x = rng.randi_range(-20,20)
	asteroid.angular_velocity.y = rng.randi_range(-20,20)
	asteroid.angular_velocity.z = rng.randi_range(-20,20)
	asteroid.inertia.x = rng.randi_range(0,20)
	asteroid.inertia.y = rng.randi_range(0,20)
	asteroid.inertia.z = rng.randi_range(0,20)
	asteroid.constant_force.x = rng.randi_range(-50,50)
	asteroid.constant_force.y = rng.randi_range(-50,50)
	asteroid.constant_force.z = rng.randi_range(-50,50)
	asteroid.constant_torque.x = rng.randi_range(-50,50)
	asteroid.constant_torque.y = rng.randi_range(-50,50)
	asteroid.constant_torque.z = rng.randi_range(-50,50)
